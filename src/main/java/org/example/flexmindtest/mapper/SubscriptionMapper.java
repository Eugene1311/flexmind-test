...
public interface SubscriptionMapper {
    SubscriptionMongoEntity toMongoEntity(Subscription subscription);
    SubscriptionElasticEntity toElasticEntity(Subscription subscription);

    Subscription toModel(SubscriptionMongoEntity entity);

    Subscription toModel(SubscriptionDto subscriptionDto);

    Subscription toModel(SubscriptionElasticEntity saved);
}
